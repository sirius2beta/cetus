...
#include "more_interfaces/msg/detail/marinelink_packet__rosidl_typesupport_fastrtps_c.h"
...
using _MarinelinkPacket__ros_msg_type = more_interfaces__msg__MarinelinkPacket;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MarinelinkPacket__ros_msg_type * ros_message = static_cast<const _MarinelinkPacket__ros_msg_type *>(untyped_ros_message);
  // Field name: topic
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MarinelinkPacket__ros_msg_type * ros_message = static_cast<_MarinelinkPacket__ros_msg_type *>(untyped_ros_message);
  // Field name: topic
  {
    cdr >> ros_message->topic;
  }
...
size_t get_serialized_size_more_interfaces__msg__MarinelinkPacket(
  const void * untyped_ros_message,
...
static uint32_t _MarinelinkPacket__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_more_interfaces__msg__MarinelinkPacket(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_more_interfaces
size_t max_serialized_size_more_interfaces__msg__MarinelinkPacket(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = more_interfaces__msg__MarinelinkPacket;
    is_plain =
      (
...
static size_t _MarinelinkPacket__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_more_interfaces__msg__MarinelinkPacket(
...
static message_type_support_callbacks_t __callbacks_MarinelinkPacket = {
  "more_interfaces::msg",
  "MarinelinkPacket",
...
static rosidl_message_type_support_t _MarinelinkPacket__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MarinelinkPacket,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, more_interfaces, msg, MarinelinkPacket)() {
  return &_MarinelinkPacket__type_support;
}
