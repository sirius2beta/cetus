...
inline std::string to_yaml(const MavlinkPacket & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const more_interfaces::msg::MavlinkPacket & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const more_interfaces::msg::MavlinkPacket & msg)
{
