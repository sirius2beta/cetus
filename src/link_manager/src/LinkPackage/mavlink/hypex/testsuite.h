...
static void mavlink_test_custom_legacy_wrapper(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_custom_legacy_wrapper_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_custom_legacy_wrapper_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.length , packet1.topic , packet1.payload );
    mavlink_msg_custom_legacy_wrapper_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_custom_legacy_wrapper_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.length , packet1.topic , packet1.payload );
    mavlink_msg_custom_legacy_wrapper_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_custom_legacy_wrapper_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_custom_legacy_wrapper_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.length , packet1.topic , packet1.payload );
    mavlink_msg_custom_legacy_wrapper_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
