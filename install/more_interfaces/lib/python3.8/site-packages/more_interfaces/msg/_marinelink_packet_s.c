...
bool more_interfaces__msg__marinelink_packet__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("more_interfaces.msg._marinelink_packet.MarinelinkPacket", full_classname_dest, 55) == 0);
  }
  more_interfaces__msg__MarinelinkPacket * ros_message = _ros_message;
  {  // topic
...
{
  /* NOTE(esteve): Call constructor of MarinelinkPacket */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("more_interfaces.msg._marinelink_packet");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MarinelinkPacket");
