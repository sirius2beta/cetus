...
bool more_interfaces__msg__mavlink_packet__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("more_interfaces.msg._mavlink_packet.MavlinkPacket", full_classname_dest, 49) == 0);
  }
  more_interfaces__msg__MavlinkPacket * ros_message = _ros_message;
  {  // payload
...
{
  /* NOTE(esteve): Call constructor of MavlinkPacket */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("more_interfaces.msg._mavlink_packet");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MavlinkPacket");
